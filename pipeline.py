...
LUA_SHA1 = get_hash(os.path.join(CWD, 'opendiary.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            #elif item_type == 'tag':
            #    wget_args.extend(['--warc-header', 'opendiary-tag: '+item_value])
            #    wget_args.append('https://www.opendiary.com/tag/{}/'.format(item_value))
            elif item_type == 'asset':
                url = 'https://' + item_value
                wget_args.extend(['--warc-header', 'opendiary-asset: '+url])
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/9/99/Opendiary-icon.png" height="50px" title=""/>
        <h2>Open Diary <span class="links"><a href="https://opendiary.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/opendiary/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/Open_Diary">Wiki</a></span></h2>
        <p>Archiving Open Diary.</p>
    '''
)
